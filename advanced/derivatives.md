...
{% hint style="info" %}
Derivatives are not generated by the SharpSync app. Derivative files are generated by the source system (E.g. Onshape, SolidWorks or SolidWorks PDM or Inventor).
{% endhint %}
